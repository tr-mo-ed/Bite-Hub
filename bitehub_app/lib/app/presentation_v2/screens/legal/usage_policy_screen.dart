      ...
      body: ListView(
        ...
        children: const [
          ...
          _PolicySection(
            ...
            body:
                'عند نجاح إلغاء طلب مدفوع بالمحفظة أو ببطاقة NFC المرتبطة بها، يعاد المبلغ تلقائياً إلى المحفظة نفسها. الطلب النقدي لا ينتج عنه استرداد إلكتروني.',
          ),
          _PolicySection(
            number: '05',
            title: 'بطاقة NFC',
            body:
                'البطاقة وسيلة تعريف للمحفظة وليست مخزناً للرصيد. الرصيد والحركات محفوظة في منظومة Bite Hub، ويمكن ربط كل بطاقة بحساب واحد فقط.',
          ),
          _PolicySection(
            number: '06',
